...
public class MenuEmpresa {
     ...
     */
    public MenuEmpresa(GestorRegistos g) {
        scanner = new Scanner(System.in);
        this.gr = g;
    }

    /**
     * Método que cria o menu EMpresa
     */
    public void print() {
        boolean flagContinue = true;
        while (flagContinue) {
            if (gr.getUtilizadorActual() instanceof EmpresaTransportadora) {
    ...
    private void menuEstadoLivre() {
        ...
        while (flagContinue) {
            ...
            out.println("*  [4] Lista de encomendas entregues          *");
            out.println("*  [5] Lista de encomendas por estado         *");
            out.println("*  [0] Sair                                   *");
            out.println(prtLin);
            out.println("***********************************************\n");
            out.println(strOpt);
    ...
    /**
     * Método que cria o menu em que o estado do transportador está ocupodo
     */
