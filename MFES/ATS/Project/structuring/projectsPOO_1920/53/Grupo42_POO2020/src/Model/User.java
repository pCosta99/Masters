...
public class User extends Entitie implements java.io.Serializable{
    ...
    public void addTransportOffer(Offer offer) {
        /*
        if (this._transportOffers.containsKey(offer.getOrderID())) {
            Map<String, Offer> inner_map = this._transportOffers.get(offer.getOrderID());
            inner_map.put(offer.getTransporterID(), offer.clone());
            this._transportOffers.put(offer.getOrderID(),inner_map);
        } else {
            Map<String, Offer> inner_map = new HashMap<>();
            inner_map.put(offer.getTransporterID(), offer.clone());
            this._transportOffers.put(offer.getTransporterID(),inner_map);
        }
         */
