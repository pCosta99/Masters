...
import Exceptions.NaoSeEncontraRaioException;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try (ObjectInputStream oin = new ObjectInputStream(new FileInputStream("save"))) {
    ...
    private static void signIn(DataBase db) {
        ...
        System.out.println(" *** Sing In ***\n1-User\n2-Transporte.Empresa\n3-Transporte.Voluntario\n4-Utilizador.Loja\n5-Voltar ao menu");
        int opcao;
        do {
            opcao = leInteiro(5);
        } while (opcao == -1);
        ...
        switch (opcao) {
            case 1:
                ...
                break;
            case 2:
                Loja l = new Loja(email, nome, password, local, 10, "");
                db.add(l);
                System.out.println(msg);
                break;
            case 3:
                Empresa e = new Empresa(email, nome, password, local, 0, 0, 0, "", 0, 0);
                db.add(e);
                System.out.println(msg);
                break;
            case 4:
                Voluntario v = new Voluntario(email, nome, password, local, 0, 0, 0, false);
                db.add(v);
                System.out.println(msg);
                break;
            default:
    ...
    private static void fazerEncomenda(Utilizador d, DataBase db) {
        ...
        System.out.println("Utilizador.Loja:");
        String mail = input.nextLine();
        e.setLoja(mail);
        ...
        System.out.println("Encomenda.Encomenda de medicamentos:\n1-Sim\n2-Nao");
        int j = input.nextInt();
        if (j == 1) {
            e.setMedicamentos(1);
        } else {
        ...
        try {
            db.addEnc(e);
            d.incNumEnc();
            System.out.println("###Encomenda.Encomenda feita com sucesso###");
    ...
    private static void defs(Utilizador d) {
        ...
        while (opcao != 5) {
            ...
            switch (opcao) {
                case 1:
                    System.out.println("Não é possivel alterar o email\n");
                    break;
                ...
                case 3:
                    System.out.println("Insira a pass\n");
    ...
    private static void classifica(DataBase db) {
        ...
        try {
            ...
            System.out.println("###Encomenda.Encomenda avaliada com sucesso###");
    ...
    private static void PreparaEncomenda(Loja d, DataBase db) {
        ...
        try {
            ...
            System.out.println("###Encomenda.Encomenda pronta para transportar###");
        } catch (EncomendaNaoExisteException i) {
            System.out.println("Referencia da encomenda invalida\n");
        }

    }
    //Area pessoal Utilizador.Loja
            ...
            switch (opcao) {
                case 1:
                    try {
                        ...
                        System.out.println("---Utilizador.Loja encontra-se fora de alcance---");
                    }
                    break;
                case 2:
                    areaPessoal(d, db);
    ...
    private static void transporta(Empresa d, DataBase db) throws NaoSeEncontraRaioException {
        ...
        if (e.isEmpty()) {
            ...
            try {
                ...
                if (d1 > d.getRaio()) {
                    throw new NaoSeEncontraRaioException();
                }
                //distancia loja -> user
                ...
                System.out.println("#######Encomenda.Encomenda transportada com sucesso######");
            } catch (EncomendaNaoExisteException i) {
                System.out.println("Referencia da encomenda invalida\n");
            }
        }
    ...
    private static void defsE(Empresa d) {
        ...
        while (opcao != 11) {
            ...
            switch (opcao) {
                ...
                case 6:
                    System.out.println("Transporte.Transporte de medicamentos:  \n");
                    int m = input.nextInt();
                ...
                case 10:
                    System.out.println("Não é possivel alterar o nif\n");
                    break;
