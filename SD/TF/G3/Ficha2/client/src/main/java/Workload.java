...
public class Workload {
    ...
    private static final int NR_REQUESTS = 100;

    // Client Stub
    private final Stub stub;

    public Workload(Account account, Random rand) throws IOException, SpreadException {
        this.account = account;
        this.rand = rand;
        this.stub = new Stub();
    }

    public void start() throws ExecutionException, InterruptedException, SpreadException {
